...
const WidgetFooter = ({disableLeftBtn, disableRightBtn, handleOnClick}: WidgetFooterProps) => {
    return (
        <div className="widget-footer">
            <IconButton
                className={`button ${disableLeftBtn ? "inactive-button" : "active-button"}`}
            ...
            <IconButton
                className={`button ${disableRightBtn ? "inactive-button" : "active-button"}`}
