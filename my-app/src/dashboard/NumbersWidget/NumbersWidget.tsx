...
const NumbersWidget = ({className}: IWidgetStandardProps) => {
    ...
    const header: string = safeTranslate("admin_dashboard.numbers_widget.numbers");
    ...
    const [subHeader, setSubheader] = useState<string | JSX.Element>(<Skeleton width="30%" />);
    ...
    useEffect(() => {
        NumbersService
            ...
            .then(
                numberManagementMetaData => {
                    setSubheader(numberManagementMetaData.flowNumberCount.toString());
                    numbersRows = [];
                    numbersRows.push({
                        id: 0,
                        label: safeTranslate("admin_dashboard.numbers_widget.ongoing_portings"),
                        additionalInfo: (numberManagementMetaData.portingsOngoingCount).toString(),
                    ...
                    numbersRows.push({
                        id: 1,
                        label: safeTranslate("admin_dashboard.numbers_widget.other_operators"),
                        additionalInfo: (numberManagementMetaData.otherOperatorCount).toString(),
